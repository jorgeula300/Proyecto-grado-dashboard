...
export function Home() {
    ...
    return (
        <div className="flex flex-col justify-center w-full h-full">
            <div className="container flex  justify-center w-[70%] h-[90%] mx-auto my-10 shadow-md shadow-[#0B2239]  bg-slate-300 break-words relative overflow-y-scroll animate-fade animate-once animate-duration-1000 animate-delay-0">
